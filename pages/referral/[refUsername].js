...
import classes from '../../component/registration-form.module.css'
...
const Referral = () => {
  ...
  async function submitHandler(event) {
      ...
      if ((enteredCouponInputRef.length === 24 || enteredCouponInputRef.length === 25 ||enteredCouponInputRef.length === 23) && enteredCouponInputRef.slice(-2) === 'UC') {
